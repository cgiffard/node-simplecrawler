...
Crawler.prototype.getRobotsTxt = function(url, callback) {
    ...
    var fetchRequest = crawler.getRequestOptions(crawler.processURL(robotsTxtUrl.href()));
 ...
 * been received, {@link Crawler.handleResponse#handleResponse} will handle the downloading of
 * the resource data
...
Crawler.prototype.fetchQueueItem = function(queueItem) {
    ...
    crawler.queue.update(queueItem.id, {
        ...
        var fetchRequest = crawler.getRequestOptions(queueItem),
 ...
 * @param {any} request
 * @param  {Response} response   An instace of [http.IncomingMessage]{@link https://nodejs.org/api/http.html#http_class_http_incomingmessage}
