...
Crawler.prototype.fetchQueueItem = function(queueItem) {
    ...
    crawler.queue.update(queueItem.id, {
        ...
        // Provent URL contains some unidentified character . 
        queueItem.path=encodeURIComponent(queueItem.path);
        queueItem.uriPath=encodeURIComponent(queueItem.uriPath);
