...
var Crawler = function(host,initialPath,initialPort,interval) {
	...
	// Maximum number of concurrent async listeners
	crawler.maxConcurrenctListeners = 5;
...
var cleanURL = function (queueItem, URL) {
	return URL
...
Crawler.prototype.crawl = function() {
	...
	crawler.queue.oldestUnfetchedItem(function(err, queueItem) {
		...
		if (crawler._openListeners > crawler.maxConcurrenctListeners)
			return false;
